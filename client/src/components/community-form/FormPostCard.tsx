...
import { ThumbsUp, ThumbsDown, UserRound } from "lucide-react";
...
export function FormPostCard({ PostData }: { PostData: FormPostCardProps }) {
  ...
  return (
    ...
    >
      ...
      />
      <div className="h-full relative flex rounded-md border border-white/10">
        <LikeDislikeSection />
...
const LikeDislikeSection = () => {
  return (
    <section className="cursor-pointer dark:bg-neutral-900 px-4 flex flex-col rounded-l-xl">
      <div className="group/like h-1/2 flex flex-col gap-2 items-center justify-center">
        <ThumbsUp className="dark:text-neutral-300 group-hover/like:text-green-300" />
        <span className="text-xs font-semibold dark:text-neutral-100 group-hover/like:text-neutral-50">1001</span>
      </div>
      <div className="group/dislike h-1/2 flex flex-col gap-2 items-center justify-center">
        <ThumbsDown className="dark:text-neutral-300 group-hover/dislike:text-red-300" />
  ...
  return (
    <section className="w-full p-3 flex flex-col gap-1 rounded-r-md">
      ...
      <div className="h-[30%] flex gap-2 items-center">
        <UserRound className="dark:text-neutral-100" />
